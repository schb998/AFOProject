...
def get_osim_file(instruction: str = None, mode: str = 'r') -> io.TextIOWrapper | None:
    return askopenfile(title=instruction, mode=mode, filetypes=[('OSIM files', '*.osim')])


def get_mot_file(instruction: str = None, mode: str = 'r') -> io.TextIOWrapper | None:
    return askopenfile(title=instruction, mode=mode, filetypes=[('MOT files', '*.mot')])


def get_xml_file(instruction: str = None, mode: str = 'r') -> io.TextIOWrapper | None:
    return askopenfile(title=instruction, mode=mode, filetypes=[('XML files', '*.xml')])


def get_trc_file(instruction: str = None, mode: str = 'r') -> io.TextIOWrapper | None:
    return askopenfile(title=instruction, mode=mode, filetypes=[('TRC files', '*.trc')])
