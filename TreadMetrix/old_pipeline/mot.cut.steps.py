...
def detect_heel_strikes(vertical_force, threshold=20):
    ...
    Parameters:
        vertical_force (array): data of vertical forces.
...
def read_mot_files(corrected_mot_path, threshold=20):
    ...
    Parameters:
        corrected_mot_path (str): Path to the directory of the corrected MOT files.
        threshold (int): Threshold for detecting heel strikes.
    ...
    for filename in file_list:
        ...
        try:
            with open(file_path, 'r') as file:
                # Read metadata
                metadata = {}
                file.readline().strip()  # Ignore descriptive line (e.g., 'walking_speed')
                ...
                # todo: test on another computer to see when and why that blank line is not there
                # file.readline()
...
if __name__ == "__main__":
    ...
    motion_data = read_mot_files(corrected_mot_path, threshold)
