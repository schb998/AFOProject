...
_opensim_path = r""            # PATH TO OPENSIM BINARIES (should end with "\OpenSim 4.5\bin")
_base_path = r""               # PATH TO BASE OUTPUT FOLDER
_osim_model_path = _base_path  # PATH TO OSIM MODEL FOLDER
_osim_model_file_name = ""     # NAME OF OSIM MODEL FILE (should end with ".osim")
