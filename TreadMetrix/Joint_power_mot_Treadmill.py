...
# Main Paths
base_path = r"D:\MyData\Pilots\Sara\Speed Trials"
ik_folder = os.path.join(base_path, "IK_Results")
id_folder = os.path.join(base_path, "ID_Results")
power_output_folder = os.path.join(base_path, "Power_Filtered")
